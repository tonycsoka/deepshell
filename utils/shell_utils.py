...
class CommandExecutor:
    ...
    async def _get_sudo_password(self):
        """Get the sudo password, either from UI or by asking the user and validate it."""
    ...
    async def _validate_sudo_password(self, sudo_password):
        """Validate the sudo password by running a harmless sudo command."""
    ...
    async def _process_command_output(self, proc, command):
        ...
        try:
            while True:
                ...
                if not self._is_text(decoded_line):
